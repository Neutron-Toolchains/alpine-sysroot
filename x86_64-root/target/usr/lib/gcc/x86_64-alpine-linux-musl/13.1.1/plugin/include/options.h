...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 741,      /* -Wpoison-system-directories */
  ...
  OPT_mandroid = 1914,                       /* -mandroid */
  OPT_march_ = 1915,                         /* -march= */
  OPT_masm_ = 1916,                          /* -masm= */
  OPT_mavx = 1917,                           /* -mavx */
  OPT_mavx2 = 1918,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1919,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1920,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1921,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1922,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1923,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1924,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1925,                      /* -mavx512bw */
  OPT_mavx512cd = 1926,                      /* -mavx512cd */
  OPT_mavx512dq = 1927,                      /* -mavx512dq */
  OPT_mavx512er = 1928,                      /* -mavx512er */
  OPT_mavx512f = 1929,                       /* -mavx512f */
  OPT_mavx512fp16 = 1930,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1931,                    /* -mavx512ifma */
  OPT_mavx512pf = 1932,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1933,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1934,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1935,                      /* -mavx512vl */
  OPT_mavx512vnni = 1936,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1937,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1938,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 1939,                       /* -mavxifma */
  OPT_mavxneconvert = 1940,                  /* -mavxneconvert */
  OPT_mavxvnni = 1941,                       /* -mavxvnni */
  OPT_mavxvnniint8 = 1942,                   /* -mavxvnniint8 */
  OPT_mbionic = 1943,                        /* -mbionic */
  OPT_mbmi = 1944,                           /* -mbmi */
  ...
  /* OPT_mcpu_ = 1956, */                    /* -mcpu= */
  OPT_mcrc32 = 1957,                         /* -mcrc32 */
  OPT_mcx16 = 1958,                          /* -mcx16 */
  OPT_mdaz_ftz = 1959,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1960,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1961,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1962,            /* -mdump-tune-features */
  OPT_menqcmd = 1963,                        /* -menqcmd */
  OPT_mf16c = 1964,                          /* -mf16c */
  OPT_mfancy_math_387 = 1965,                /* -mfancy-math-387 */
  OPT_mfentry = 1966,                        /* -mfentry */
  OPT_mfentry_name_ = 1967,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1968,               /* -mfentry-section= */
  OPT_mfma = 1969,                           /* -mfma */
  OPT_mfma4 = 1970,                          /* -mfma4 */
  OPT_mforce_drap = 1971,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1972,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1973,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1974,                       /* -mfpmath= */
  OPT_mfsgsbase = 1975,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1976,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1977, */              /* -mfused-madd */
  OPT_mfxsr = 1978,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1979,             /* -mgeneral-regs-only */
  OPT_mgfni = 1980,                          /* -mgfni */
  OPT_mglibc = 1981,                         /* -mglibc */
  OPT_mhard_float = 1982,                    /* -mhard-float */
  OPT_mharden_sls_ = 1983,                   /* -mharden-sls= */
  OPT_mhle = 1984,                           /* -mhle */
  OPT_mhreset = 1985,                        /* -mhreset */
  OPT_miamcu = 1986,                         /* -miamcu */
  OPT_mieee_fp = 1987,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1988,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1989,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1990,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1991,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1992,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1993,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1994,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1995, */            /* -mintel-syntax */
  OPT_mkl = 1996,                            /* -mkl */
  OPT_mlam_ = 1997,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 1998,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1999,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2000,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2001,                /* -mlong-double-80 */
  OPT_mlwp = 2002,                           /* -mlwp */
  OPT_mlzcnt = 2003,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2004,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2005,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2006,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2007,                  /* -mmitigate-rop */
  OPT_mmmx = 2008,                           /* -mmmx */
  OPT_mmovbe = 2009,                         /* -mmovbe */
  OPT_mmovdir64b = 2010,                     /* -mmovdir64b */
  OPT_mmovdiri = 2011,                       /* -mmovdiri */
  OPT_mmove_max_ = 2012,                     /* -mmove-max= */
  OPT_mmpx = 2013,                           /* -mmpx */
  OPT_mms_bitfields = 2014,                  /* -mms-bitfields */
  OPT_mmusl = 2015,                          /* -mmusl */
  ...
  OPT_mnop_mcount = 2025,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2026,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 2027,                          /* -mpc32 */
  OPT_mpc64 = 2028,                          /* -mpc64 */
  OPT_mpc80 = 2029,                          /* -mpc80 */
  OPT_mpclmul = 2030,                        /* -mpclmul */
  OPT_mpcommit = 2031,                       /* -mpcommit */
  OPT_mpconfig = 2032,                       /* -mpconfig */
  OPT_mpku = 2033,                           /* -mpku */
  OPT_mpopcnt = 2034,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2035, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2036,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2037,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2038,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2039,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2040,                        /* -mprfchw */
  OPT_mptwrite = 2041,                       /* -mptwrite */
  OPT_mpush_args = 2042,                     /* -mpush-args */
  OPT_mraoint = 2043,                        /* -mraoint */
  OPT_mrdpid = 2044,                         /* -mrdpid */
  OPT_mrdrnd = 2045,                         /* -mrdrnd */
  OPT_mrdseed = 2046,                        /* -mrdseed */
  OPT_mrecip = 2047,                         /* -mrecip */
  OPT_mrecip_ = 2048,                        /* -mrecip= */
  OPT_mrecord_mcount = 2049,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2050,                 /* -mrecord-return */
  OPT_mred_zone = 2051,                      /* -mred-zone */
  OPT_mregparm_ = 2052,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2053,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2054,                           /* -mrtd */
  OPT_mrtm = 2055,                           /* -mrtm */
  OPT_msahf = 2056,                          /* -msahf */
  OPT_mserialize = 2057,                     /* -mserialize */
  OPT_msgx = 2058,                           /* -msgx */
  OPT_msha = 2059,                           /* -msha */
  OPT_mshstk = 2060,                         /* -mshstk */
  OPT_mskip_rax_setup = 2061,                /* -mskip-rax-setup */
  OPT_msoft_float = 2062,                    /* -msoft-float */
  OPT_msse = 2063,                           /* -msse */
  OPT_msse2 = 2064,                          /* -msse2 */
  OPT_msse2avx = 2065,                       /* -msse2avx */
  OPT_msse3 = 2066,                          /* -msse3 */
  OPT_msse4 = 2067,                          /* -msse4 */
  OPT_msse4_1 = 2068,                        /* -msse4.1 */
  OPT_msse4_2 = 2069,                        /* -msse4.2 */
  OPT_msse4a = 2070,                         /* -msse4a */
  /* OPT_msse5 = 2071, */                    /* -msse5 */
  OPT_msseregparm = 2072,                    /* -msseregparm */
  OPT_mssse3 = 2073,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2074,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2075, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2076,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2077, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2078,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2079,                  /* -mstackrealign */
  OPT_mstore_max_ = 2080,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2081,            /* -mstringop-strategy= */
  OPT_mstv = 2082,                           /* -mstv */
  OPT_mtbm = 2083,                           /* -mtbm */
  OPT_mtls_dialect_ = 2084,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2085,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2086,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2087,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2088,                         /* -mtune= */
  OPT_muclibc = 2089,                        /* -muclibc */
  OPT_muintr = 2090,                         /* -muintr */
  OPT_munroll_only_small_loops = 2091,       /* -munroll-only-small-loops */
  OPT_mvaes = 2092,                          /* -mvaes */
  OPT_mveclibabi_ = 2093,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2094,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2095,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2096,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2097,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2098,                      /* -mwbnoinvd */
  OPT_mwidekl = 2099,                        /* -mwidekl */
  OPT_mx32 = 2100,                           /* -mx32 */
  OPT_mxop = 2101,                           /* -mxop */
  OPT_mxsave = 2102,                         /* -mxsave */
  OPT_mxsavec = 2103,                        /* -mxsavec */
  OPT_mxsaveopt = 2104,                      /* -mxsaveopt */
  OPT_mxsaves = 2105,                        /* -mxsaves */
  OPT_n = 2106,                              /* -n */
  OPT_name_sort = 2107,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2108,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2109,              /* -no-integrated-cpp */
  OPT_no_pie = 2110,                         /* -no-pie */
  OPT_nocpp = 2111,                          /* -nocpp */
  OPT_nodefaultlibs = 2112,                  /* -nodefaultlibs */
  OPT_nolibc = 2113,                         /* -nolibc */
  OPT_nophoboslib = 2114,                    /* -nophoboslib */
  OPT_nostartfiles = 2115,                   /* -nostartfiles */
  OPT_nostdinc = 2116,                       /* -nostdinc */
  OPT_nostdinc__ = 2117,                     /* -nostdinc++ */
  OPT_nostdlib = 2118,                       /* -nostdlib */
  OPT_nostdlib__ = 2119,                     /* -nostdlib++ */
  OPT_o = 2120,                              /* -o */
  OPT_objects = 2121,                        /* -objects */
  OPT_p = 2122,                              /* -p */
  OPT_pass_exit_codes = 2123,                /* -pass-exit-codes */
  /* OPT_pedantic = 2124, */                 /* -pedantic */
  OPT_pedantic_errors = 2125,                /* -pedantic-errors */
  OPT_pg = 2126,                             /* -pg */
  OPT_pie = 2127,                            /* -pie */
  OPT_pipe = 2128,                           /* -pipe */
  OPT_posix = 2129,                          /* -posix */
  ...
  OPT_profile = 2142,                        /* -profile */
  OPT_pthread = 2143,                        /* -pthread */
  OPT_quiet = 2144,                          /* -quiet */
  OPT_r = 2145,                              /* -r */
  OPT_rdynamic = 2146,                       /* -rdynamic */
  OPT_remap = 2147,                          /* -remap */
  OPT_reverse_sort = 2148,                   /* -reverse-sort */
  OPT_s = 2149,                              /* -s */
  OPT_save_temps = 2150,                     /* -save-temps */
  OPT_save_temps_ = 2151,                    /* -save-temps= */
  OPT_shared = 2152,                         /* -shared */
  OPT_shared_libgcc = 2153,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2154,               /* -shared-libphobos */
  OPT_size_sort = 2155,                      /* -size-sort */
  /* OPT_specs = 2156, */                    /* -specs */
  OPT_specs_ = 2157,                         /* -specs= */
  OPT_static = 2158,                         /* -static */
  OPT_static_libasan = 2159,                 /* -static-libasan */
  OPT_static_libgcc = 2160,                  /* -static-libgcc */
  OPT_static_libgfortran = 2161,             /* -static-libgfortran */
  OPT_static_libgm2 = 2162,                  /* -static-libgm2 */
  OPT_static_libgo = 2163,                   /* -static-libgo */
  OPT_static_libhwasan = 2164,               /* -static-libhwasan */
  OPT_static_liblsan = 2165,                 /* -static-liblsan */
  OPT_static_libmpx = 2166,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2167,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2168,               /* -static-libphobos */
  OPT_static_libquadmath = 2169,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2170,               /* -static-libstdc++ */
  OPT_static_libtsan = 2171,                 /* -static-libtsan */
  OPT_static_libubsan = 2172,                /* -static-libubsan */
  OPT_static_pie = 2173,                     /* -static-pie */
  /* OPT_std_c__03 = 2174, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2175, */                /* -std=c++0x */
  OPT_std_c__11 = 2176,                      /* -std=c++11 */
  OPT_std_c__14 = 2177,                      /* -std=c++14 */
  OPT_std_c__17 = 2178,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2179, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2180, */                /* -std=c++1z */
  OPT_std_c__20 = 2181,                      /* -std=c++20 */
  OPT_std_c__23 = 2182,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2183, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2184, */                /* -std=c++2b */
  OPT_std_c__98 = 2185,                      /* -std=c++98 */
  OPT_std_c11 = 2186,                        /* -std=c11 */
  OPT_std_c17 = 2187,                        /* -std=c17 */
  /* OPT_std_c18 = 2188, */                  /* -std=c18 */
  /* OPT_std_c1x = 2189, */                  /* -std=c1x */
  OPT_std_c2x = 2190,                        /* -std=c2x */
  /* OPT_std_c89 = 2191, */                  /* -std=c89 */
  OPT_std_c90 = 2192,                        /* -std=c90 */
  OPT_std_c99 = 2193,                        /* -std=c99 */
  /* OPT_std_c9x = 2194, */                  /* -std=c9x */
  OPT_std_f2003 = 2195,                      /* -std=f2003 */
  OPT_std_f2008 = 2196,                      /* -std=f2008 */
  OPT_std_f2008ts = 2197,                    /* -std=f2008ts */
  OPT_std_f2018 = 2198,                      /* -std=f2018 */
  ...
  /* OPT_std_gnu__2a = 2210, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2211, */              /* -std=gnu++2b */
  ...
  OPT_std_gnu2x = 2217,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2218, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2219,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2220,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2221, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2222, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2223,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2224, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2225, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2226, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2227, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2228, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2229,                     /* -std=legacy */
  OPT_stdlib_ = 2230,                        /* -stdlib= */
  OPT_symbol_ = 2231,                        /* -symbol= */
  OPT_symbolic = 2232,                       /* -symbolic */
  OPT_t = 2233,                              /* -t */
  OPT_time = 2234,                           /* -time */
  OPT_time_ = 2235,                          /* -time= */
  OPT_tno_android_cc = 2236,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2237,                 /* -tno-android-ld */
  OPT_traditional = 2238,                    /* -traditional */
  OPT_traditional_cpp = 2239,                /* -traditional-cpp */
  OPT_tree_stats = 2240,                     /* -tree-stats */
  OPT_trigraphs = 2241,                      /* -trigraphs */
  OPT_type_stats = 2242,                     /* -type-stats */
  OPT_u = 2243,                              /* -u */
  OPT_undef = 2244,                          /* -undef */
  OPT_v = 2245,                              /* -v */
  OPT_version = 2246,                        /* -version */
  OPT_w = 2247,                              /* -w */
  OPT_wrapper = 2248,                        /* -wrapper */
  OPT_x = 2249,                              /* -x */
  OPT_z = 2250,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
